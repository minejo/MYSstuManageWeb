...
var where = new Array(35);
	...
	function select() {
		with (document.creator.native_place) {
...
/*addNews相关js*/	
	 ...
	 **/
	 KE.show({
			id : 'newsContent',
			imageUploadJson : '/mys/kindeditor/jsp/upload_json.jsp',
			fileManagerJson : '/mys/kindeditor/jsp/file_manager_json.jsp',
	...
	function IsLink(str){
		if(str == "show"){
			...
			$("#isFile").css("display","none");
			$("#file").css("display","none");
		}else{
			$("#newsUrl").css("display","none");
			$("#isImage").css("display","");
			$("#image").css("display","none");
			$("#content").css("display","");
			$("#isFile").css("display","");
